...
public class TypeCheck extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String result) {
        ...
        Toast.makeText(context, "yo" + type + res, Toast.LENGTH_SHORT).show();
        Toast.makeText(context, "yo" + type + result, Toast.LENGTH_SHORT).show();
        Toast.makeText(context, "HEY "+arr[0]+arr[1]+arr[2]+arr[3]+arr[4], Toast.LENGTH_SHORT).show();
