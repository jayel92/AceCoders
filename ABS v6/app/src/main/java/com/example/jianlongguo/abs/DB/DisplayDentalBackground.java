 ...
 */
public class DisplayDentalBackground extends AsyncTask<Object, String, Appointment> {
    ...
    public DisplayDentalBackground(Context context, Patient p1) {
    ...
    protected Appointment doInBackground(Object... arg0) {
        try {
            String link = "http://acecoders.netau.net/viewDental.php";
